      ...
      <section className="section section2" ref={el => (sectionRefs.current[1] = el)}>
        ...
        <div className="text-overlay">
          ...
          <p>우리나라는 전력 생산 과정에서 많은 온실가스를 배출하고 있습니다. </p>
            ...
            <br></br>
          <p>탄소중립을 위해서는 배출되는 온실가스의 양을 줄여야합니다. 이를 위해서는 에너지 생산 <br />
            방식의 전환이 필수적입니다.</p>
            <br></br>
          <p>신재생에너지는 발전과정에서 이산화탄소를 거의 배출하지 않기 때문에, 탄소중립 목표를 <br />
            달성하기 위한 핵심수단으로 꼽힙니다.</p>
            <br></br>
          <p>정부도 2050년 탄소중립을 목표로 삼고 있으며, 화석연료 발전을 단계적으로 감축하고, <br />
